...
export default [
    ...
    new ProjectData("project-3", "Labyrinth","A short platformer made in a week", "img/projects/Labyrinth/final.jpg", `
    <div class="paragraph">
    ...
    `, "#000000"),
    new ProjectData("project-4", "Neon Ballz","A simple endless runner made in 48 hours","img/projects/NeonBallz/img3.png", `
    <div class="paragraph">
